...
export function ParlayCard({ parlay }: { parlay: Parlay }) {
  return (
    <article className="rounded-xl border border-gray-800 bg-gray-900 p-4">
      ...
      <div className="mt-2 text-sm text-gray-300">EV +{parlay.combined_ev_pct.toFixed(1)}% · {parlay.num_legs} legs</div>
      <div className="text-xs text-gray-500">Kelly {parlay.suggested_kelly_fraction.toFixed(3)}</div>
