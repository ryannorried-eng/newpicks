...
export function ROIChart({ data }: { data: { date: string; roi: number }[] }) {
  if (!data.length) return <div className="rounded-xl border border-gray-800 bg-gray-900 p-8 text-gray-400">No settled picks yet — picks will be graded automatically after games complete.</div>;
